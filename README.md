...
| **C1** | `Conv2d(3→96, 11x11, stride 4)` + scaled tanh | `96 × 54 × 54` | ? |
| **S2** | `MaxPool2d(3x3, stride 2)` | `96 x 26 x 26` | 0 |
| **C3** | `Conv2d(96→256, 5x5, pad 2)` + scaled tanh | `256 x 26 x 26` | ? |
| **S4** | `MaxPool2d(3x3, stride 2)` | `256 × 12 × 12` | 0 |
| **C5** | `Conv2d(256→384, 3x3, pad 1)` + scaled tanh | `384 × 12 x 12` | ? |
| **C6** | `Conv2d(384→384, 3x3, pad 1)` + scaled tanh | `384 × 12 x 12` | ? |
| **C7** | `Conv2d(384→256, 3x3, pad 1)` + scaled tanh | `256 × 12 x 12` | ? |
| **S8** | `MaxPool2d(3x3, stride 2)` | `256 x 5 x 5` | ? |
| **F9** | `Linear(256x5x5=6400→4096)` + scaled tanh | `4096` | ? |
| **D9** | `Dropout(p=0.5)` | `-` | 0 |
| **F10** | `Linear(4096→4096)` + scaled tanh | `4096` | ? |
| **D10** | `Dropout(p=0.5)` | `-` | 0 |
